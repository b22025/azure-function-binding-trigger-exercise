...
@app.event_hub_message_trigger(arg_name="azeventhub", event_hub_name="test-hub",
                               connection="dt003eventhub_RootManageSharedAccessKey_EVENTHUB") 
...
@app.event_hub_output(arg_name="event", event_hub_name="test-hub3",
                      connection="dt003eventhub_RootManageSharedAccessKey_EVENTHUB")
def event_hub_output(req:func.HttpRequest, event: func.Out[str]) -> func.HttpResponse:
...
#     arg_name="event", event_hub_name="test-hub", connection="dt003eventhub_RootManageSharedAccessKey_EVENTHUB"
# )
